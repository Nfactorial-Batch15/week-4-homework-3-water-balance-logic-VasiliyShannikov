...
struct DaylyIntakeSettings: View {
...
struct DaylyIntakeSettings_Previews: PreviewProvider {
    static var previews: some View {
        DaylyIntakeSettings(isActive: .constant(true), goalNomber: "", data: ProgrammData())
    }
}
