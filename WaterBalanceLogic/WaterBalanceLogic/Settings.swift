    ...
    var body: some View {
        ...
        VStack{
            ...
            NavigationLink(isActive: $toDaylyIntake) {
                DaylyIntakeSettings(isActive: $toDaylyIntake, goalNomber: UserDefaults.standard.string(forKey: "activeGoal") ?? "goal1", data: data)
//                DaylyIntakeSettings(isActive: $toReminderChoser, goalNomber: <#T##String#>)
            } label: {
                EmptyView()
            }
